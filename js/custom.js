...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (c.maxValue = 6e3,
            ...
            $("#chart_gauge_02").length) var d = document.getElementById("chart_gauge_02"),
...
function init_cropper() {
    if ("undefined" != typeof $.fn.cropper) {
        ...
        $('[data-toggle="tooltip"]').tooltip(),
            ...
            $.isFunction(document.createElement("canvas").getContext) || $('button[data-method="getCroppedCanvas"]').prop("disabled",
                !0),
            "undefined" == typeof document.createElement("cropper").style.transition && ($('button[data-method="rotate"]').prop("disabled",
                    !0),
                $('button[data-method="scale"]').prop("disabled",
                    !0)),
...
function init_daterangepicker() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange span").html(moment().subtract(29,
                "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")),
...
function init_daterangepicker_right() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange_right span").html(moment().subtract(29,
                "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")),
